  ...
  return (
    <Layout>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              <div>
                <h2 className="font-heading text-2xl font-normal text-foreground mb-6">
                  Get in Touch
                </h2>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4 p-6 rounded-2xl bg-secondary/30">
            ...
            {/* Contact Form */}
            <div>
              <form onSubmit={handleSubmit} className="p-8 bg-secondary/30 border border-foreground/10 space-y-6">
                <h2 className="font-heading text-2xl font-normal text-foreground mb-2">
                  Send a Message
                </h2>
      ...
      <section className="py-32 bg-secondary/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="overflow-hidden h-[400px] bg-secondary/30 border border-foreground/10 flex items-center justify-center">
            <div className="text-center">
              <MapPin className="w-16 h-16 text-primary/30 mx-auto mb-4" strokeWidth={1} />
              <p className="text-muted-foreground">
